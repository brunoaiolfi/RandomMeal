...
@aot_dso_cache = dso_local local_unnamed_addr global [783 x %struct.DSOCacheEntry] [
	%struct.DSOCacheEntry {
		i64 u0x00a2ced568899a5e, ; from name: libaot-Refit.dll.so
		i64 u0x00a2ced568899a5e, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.22_name, ; name: libaot-Refit.dll.so
		ptr null; void* handle
	}, ; 0
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x0fb94003c1ad7813, ; from name: Refit.so
		i64 u0x00a2ced568899a5e, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.22_name, ; name: libaot-Refit.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.79_name, ; name: libaot-System.Runtime.Serialization.Primitives.dll.so
		ptr null; void* handle
	}, ; 90
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x2f2f84156ee6d26e, ; from name: aot-RandomMeal.dll.so
		i64 u0x76b7108579c2738b, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-RandomMeal.dll.so
		ptr null; void* handle
	}, ; 145
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x4aca010b7cc138e0, ; from name: aot-RandomMeal
		i64 u0x76b7108579c2738b, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-RandomMeal.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x4bd5ce51eacd47d7, ; from name: libaot-Refit.so
		i64 u0x00a2ced568899a5e, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.22_name, ; name: libaot-Refit.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x4cc29a3bf5efb618, ; from name: libaot-Refit
		i64 u0x00a2ced568899a5e, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.22_name, ; name: libaot-Refit.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x4f8219493990191d, ; from name: aot-RandomMeal.so
		i64 u0x76b7108579c2738b, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-RandomMeal.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x5ac455e0e08f158f, ; from name: aot-Refit
		i64 u0x00a2ced568899a5e, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.22_name, ; name: libaot-Refit.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x615270fb8d313a59, ; from name: RandomMeal.dll.so
		i64 u0x76b7108579c2738b, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-RandomMeal.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x659dc45417570048, ; from name: Refit
		i64 u0x00a2ced568899a5e, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.22_name, ; name: libaot-Refit.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x6e236ec48d460355, ; from name: RandomMeal
		i64 u0x76b7108579c2738b, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-RandomMeal.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x76b7108579c2738b, ; from name: libaot-RandomMeal.dll.so
		i64 u0x76b7108579c2738b, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-RandomMeal.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x7fbe9c35b93e0cfb, ; from name: libaot-RandomMeal
		i64 u0x76b7108579c2738b, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-RandomMeal.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x8542ec4b81a63264, ; from name: Refit.dll.so
		i64 u0x00a2ced568899a5e, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.22_name, ; name: libaot-Refit.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xb88dcaf37dd4026e, ; from name: aot-Refit.dll.so
		i64 u0x00a2ced568899a5e, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.22_name, ; name: libaot-Refit.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xc0fa406e85018c62, ; from name: libaot-RandomMeal.so
		i64 u0x76b7108579c2738b, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-RandomMeal.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xce1ac61bf5846469, ; from name: aot-Refit.so
		i64 u0x00a2ced568899a5e, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.22_name, ; name: libaot-Refit.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xdbad5f50fcaf8b56, ; from name: RandomMeal.so
		i64 u0x76b7108579c2738b, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-RandomMeal.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [27 x i8] c"com.companyname.randommeal\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [25 x i8] c"libaot-RandomMeal.dll.so\00", align 16
...
@.DSOCacheEntry.22_name = private unnamed_addr constant [20 x i8] c"libaot-Refit.dll.so\00", align 16
...
@.DSOCacheEntry.79_name = private unnamed_addr constant [54 x i8] c"libaot-System.Runtime.Serialization.Primitives.dll.so\00", align 16
